...
function Methodology() {
  return (
    <section className="mt-5" id="Methodology">
      <h1 className="text-center mb-5" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 700 }}>
        Methodology
      </h1>
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 pb-4 pb-lg-0 d-flex flex-column align-items-center">
              <img
                ...
                style={{ maxHeight: '300px', maxWidth: '70%', objectFit: 'contain', marginRight: '100px' }}
                src="/deers.png"
                alt="Elephant illustration for Smart Farm Security System"
              />
              <img
                className="img-fluid rounded shadow mb-4"
                style={{ maxHeight: '300px', maxWidth: '100%', objectFit: 'contain', marginRight: '100px' }}
                src="/elephant.png"
                alt="Sensor illustration for Smart Farm Security System"
              />
              <img
                className="img-fluid rounded shadow"
                style={{ maxHeight: '280px', maxWidth: '80%', objectFit: 'contain', marginRight: '100px' }}
                src="/Wildboars.png"
